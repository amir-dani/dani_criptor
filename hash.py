...
def logo1():
 ...
 .S_sSSs     .S_SSSs     .S_sSSs     .S    sSSs   .S_sSSs     .S   .S_sSSs    sdSS_SSSSSSbs    sSSs_sSSs     .S_sSSs    
.SS~YS%%b   .SS~SSSSS   .SS~YS%%b   .SS   d%%SP  .SS~YS%%b   .SS  .SS~YS%%b   YSSS~S%SSSSSP   d%%SP~YS%%b   .SS~YS%%b   
S%S   `S%b  S%S   SSSS  S%S   `S%b  S%S  d%S'    S%S   `S%b  S%S  S%S   `S%b       S%S       d%S'     `S%b  S%S   `S%b  
S%S    S%S  S%S    S%S  S%S    S%S  S%S  S%S     S%S    S%S  S%S  S%S    S%S       S%S       S%S       S%S  S%S    S%S  
S%S    S&S  S%S SSSS%S  S%S    S&S  S&S  S&S     S%S    d*S  S&S  S%S    d*S       S&S       S&S       S&S  S%S    d*S  
S&S    S&S  S&S  SSS%S  S&S    S&S  S&S  S&S     S&S   .S*S  S&S  S&S   .S*S       S&S       S&S       S&S  S&S   .S*S  
S&S    S&S  S&S    S&S  S&S    S&S  S&S  S&S     S&S_sdSSS   S&S  S&S_sdSSS        S&S       S&S       S&S  S&S_sdSSS   
S&S    S&S  S&S    S&S  S&S    S&S  S&S  S&S     S&S~YSY%b   S&S  S&S~YSSY         S&S       S&S       S&S  S&S~YSY%b   
S*S    d*S  S*S    S&S  S*S    S*S  S*S  S*b     S*S   `S%b  S*S  S*S              S*S       S*b       d*S  S*S   `S%b  
S*S   .S*S  S*S    S*S  S*S    S*S  S*S  S*S.    S*S    S%S  S*S  S*S              S*S       S*S.     .S*S  S*S    S%S  
S*S_sdSSS   S*S    S*S  S*S    S*S  S*S   SSSbs  S*S    S&S  S*S  S*S              S*S        SSSbs_sdSSS   S*S    S&S  
SSS~YSSY    SSS    S*S  S*S    SSS  S*S    YSSP  S*S    SSS  S*S  S*S              S*S         YSSP~YSSY    S*S    SSS  
    ...
    print(color.LIGHTWHITE_EX+'''
              +  (Dani_Criptor)  +
        | Developer:Amirhosine_dani    |
        | rubika:@xXx_bat16            |
        | Email:rootamir3@gmail.com    |
        | GitHub:amir-dani             | 
        --------------------------------
		  ''')
def quiting():
